                                    ...
                                    <div className="p-0 ms-auto rounded-circle profile-photo-edit">
                                        <Input id="profile-foreground-img-file-input" type="file"
                                            ...
                                            onChange={(event) => {
                                                ...
                                                if(file && file.type.substr(0, 5) === 'image') setCoverImage(file);
                                                else setCoverImage({});
                                            }} />
                                    ...
                                    <div className="d-flex align-items-center mb-5">
                                        ...
                                        <div className="flex-shrink-0">
                                            <Link to="#" className="badge bg-light text-primary fs-12"><i
                                                className="ri-edit-box-line align-bottom me-1" /> Edit</Link>
                                        </div>
                                    </div>
                            ...
                            <Card>
                                <CardBody>
                                    <div className="d-flex align-items-center mb-4">
                                        ...
                                        <div className="flex-shrink-0">
                                            <Link to="#" className="badge bg-light text-primary fs-12"><i
                                                className="ri-add-fill align-bottom me-1" /> Add</Link>
                                        </div>
                                    </div>
                                                    ...
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="text" className="form-control" id="lastnameInput"
                                                                placeholder="Enter your lastname" onChange={(e) => setProfile(produce(profile, draft => {draft.name.last = e.target.value}))}
                                                    ...
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="text" className="form-control"
                                                                id="phonenumberInput"
                                                                onChange={(e) => setProfile(produce(profile, draft => {draft.contact.phone_number = e.target.value}))}
                                                                placeholder="Enter your phone number"
                                                                defaultValue={profile?.contact?.phone_number} />
                                                        </div>
                                                    </Col>
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="email" className="form-control" id="emailInput"
                                                                ...
                                                                onChange={(e) => setProfile(produce(profile, draft => {draft.email = e.target.value}))}
                                                    ...
                                                    <Col lg={12}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Flatpickr
                                                                ...
                                                                onChange={(e) => setProfile(produce(profile, draft => {draft.contact.join_date = e[0]}))}
                                                                placeholder='Select Date'
                                                                defaultValue={formatDate(profile?.join_date)}
                                                                // defaultDate={"today"}
                                                                options={{
                                                                    dateFormat: "d M, Y"
                                                                }}
                                                    ...
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="text" className="form-control" id="websiteInput1"
                                                                placeholder="www.example.com" defaultValue={profile?.contact?.website}
                                                                onChange={(e) => setProfile(produce(profile, draft => {draft.contact.website = e.target.value}))}
                                                                />
                                                        </div>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="text" className="form-control" id="cityInput"
                                                                placeholder="City" defaultValue={profile?.contact?.city}
                                                                onChange={(e) => setProfile(produce(profile, draft => {draft.contact.city = e.target.value}))}
                                                            />
                                                        </div>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="text" className="form-control" id="countryInput"
                                                                placeholder="Country" defaultValue={profile?.contact?.country} 
                                                                onChange={(e) => setProfile(produce(profile, draft => {draft.contact.country = e.target.value}))}
                                                            />
                                                        </div>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="text" className="form-control" minLength="5"
                                                                ...
                                                                placeholder="Enter zipcode" defaultValue={profile?.contact?.zip_code}
                                                                onChange={(e) => setProfile(produce(profile, draft => {draft.contact.zip_code = e.target.value}))} 
                                                            />
                                                        </div>
                                                    </Col>
                                                    <Col lg={12}>
                                                        <div className="mb-3 pb-2">
                                                            ...
                                                            <textarea className="form-control"
                                                                ...
                                                                onChange={(e) => setProfile(produce(profile, draft => {draft.about = e.target.value}))}
                                                                rows="3" defaultValue={profile?.about} />
                                                        </div>
                                                    </Col>
                                                    <Col lg={12}>
                                                    ...
                                                    <Col lg={4}>
                                                        <div>
                                                            ...
                                                            <Input type="password" className="form-control"
                                                                id="oldpasswordInput"
                                                                onChange={(e) => setPassword(produce(password, draft => {draft.password = e.target.value}))}
                                                    ...
                                                    <Col lg={4}>
                                                        <div>
                                                            ...
                                                            <Input type="password" className="form-control"
                                                                ...
                                                                onChange={(e) => setPassword(produce(password, draft => {draft.newPassword = e.target.value}))}
                                                                />
                                                        </div>
                                                    </Col>
                                                    ...
                                                    <Col lg={4}>
                                                        <div>
                                                            <Label htmlFor="confirmpasswordInput" className="form-label">Confirm
                                                                Password*</Label>
                                                            <Input type="password" className="form-control"
                                                                onChange={(e) => setPassword(produce(password, draft => {draft.confirmNewPassword = e.target.value}))}
